package main;/*==========================================================*/
/* This is the Context class in the main.state.State pattern. This  class together
/* with the state class hierarchy are so organized that the main.BankContext
/* contains higher business logics, and only in main.BankContext, the dada file

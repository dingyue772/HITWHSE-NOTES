...
import main.info.AgentInfo;
import main.info.EncryptedInfo1;
import main.info.EncryptedInfo2;
import main.info.EncryptedInfo3;
import main.writer.DBWriter;
import main.writer.MessageWriter;
import main.writer.TxtFileWriter;
import main.writer.XmlFileWriter;
...
public class ClientGUI extends JPanel{
   ...
   private static final String BIDIRSHIFTENCRYPTION = "BiShift Encryption";
    private static final String CaesarCRYPTION = "Caesar Encryption";
   ...
   public ClientGUI(){
	  ...
	  cmbEncryptMethod.addItem(CaesarCRYPTION);
      ...
      if (e.getActionCommand().equals(ENCRYPT)) {
        ...
        //Create a customer object
         ...
         if(encryptWay.compareTo(BIDIRSHIFTENCRYPTION)==0)
          ...
          if(encryptWay.compareTo(CaesarCRYPTION)==0)
